...
func (h *campaignHandler) CreateImage(c *gin.Context) {
	...
	existingCampaign, err := h.campaignService.GetCampaignByID(campaign.GetDetailDetailInput{ID: id})
...
func (h *campaignHandler) Edit(c *gin.Context) {
	...
	existingCampaign, err := h.campaignService.GetCampaignByID(campaign.GetDetailDetailInput{id})
...
func (h *campaignHandler) Update(c *gin.Context) {
	...
	_, err = h.campaignService.UpdateCampaign(campaign.GetDetailDetailInput{ID: id}, updateInput)
...
func (h *campaignHandler) Show(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "campaign_detail.html", existingCampaign)
}
